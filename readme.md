 ...
 * ```-pcf```: Force Pull Certificates. This is another windows-exclusive command that will pull certificate files, even if they already exist in the file system. Using this can slow down your install time significantly.